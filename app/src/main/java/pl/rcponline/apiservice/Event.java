...
public class Event {
    ...
    private String location, comment, datetime, error;
...
//    }
    ...
    public Event(int _id, int typeId, int _sourceId, String _datetime, String _location, String _comment, int _status, String _error){
